...
public class pop_up_cse_sem1_sub6 extends AppCompatActivity implements View.OnClickListener {
    ...
    public class Constants5 {
        ...
        public static final String STORAGE_PATH_UPLOADS = "sem1sub6/";
    ...
    private void uploadFile(Uri data) {
        ...
        StorageReference sRef = mStorageReference.child(Constants5.STORAGE_PATH_UPLOADS + System.currentTimeMillis() + ".pdf");
        sRef.putFile(data)
